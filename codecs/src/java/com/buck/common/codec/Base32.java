...
public class Base32 extends Codec {
    ...
    static {
        ...
        for (int i = 'Z'; i >= 'A'; i--) {
            base32Alphabet[i] = (byte) (i - 'A');
        }
        for (int i = '7'; i >= '2'; i--) {
            base32Alphabet[i] = (byte) (i - '2' + 26);
        }

        // encode alphabet
        for (int i = 0; i <= 25; i++) {
            lookUpBase32Alphabet[i] = (byte) ('A' + i);
        }
        for (int i = 26, j = 0; i <= 31; i++, j++) {
            lookUpBase32Alphabet[i] = (byte) ('2' + j);
        }
    }
    ...
    public CodecDecoder newDecoder() {
        return new Base32.Decoder(this);
    }
    ...
    public CodecEncoder newEncoder() {
        return new Base32.Encoder(this);
    }
}
